...
%
% Calculates the factors, F, and loading parameters, lam, for the (TxN)
% matrix of errors with missing values (NaN), the number of factors is R.
% The EM-algorithm similar to the one suggested by Stock and Watson (2002,
% JBES), however with a standard principal components analysis.
%
...
%
% Delivers a (RxN) matrix of parameters and a Txr matrix of factors.
